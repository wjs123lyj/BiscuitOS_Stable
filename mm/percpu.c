...
#undef PCPU_SETUP_BUG_ON
	...
	pcpu_slot = (struct list_head *)(unsigned long)(
	 ...
	 */
	schunk = (struct pcpu_chunk *)(unsigned long)(
	...
	if(dyn_size) {
		dchunk = (struct pcpu_chunk *)(unsigned long)(
				alloc_bootmem(pcpu_chunk_struct_size));
