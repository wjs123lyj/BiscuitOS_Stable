 ...
 * ARMv6+ is never VIVT
 * ARMv7+ VIPT never aliases on D-side.
 */
 ...
 */
#if defined(CONFIG_CPU_CACHE_VIVT) && !defined(CONFIG_CPUCACHE_VIPT)
...
static inline unsigned int cacheid_is(unsigned long mask)
{
